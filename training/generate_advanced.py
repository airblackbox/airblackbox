...
ARTICLE_QA = [
    ...
    # General
    {"q": "What is the EU AI Act and when does it take effect?", "a": "The EU AI Act (Regulation (EU) 2024/1689) is the world's first comprehensive legal framework for artificial intelligence. It was adopted on June 13, 2024 and enters into force in phases: (1) February 2, 2025: Prohibitions on unacceptable risk AI (Article 5), (2) August 2, 2025: Rules for general-purpose AI models, (3) August 2, 2026: general application, with high-risk AI system requirements subsequently pushed back to December 2027. It applies to providers placing AI systems on the EU market, deployers using AI in the EU, and providers/deployers outside the EU whose AI system output is used in the EU. Penalties: up to €35 million or 7% of global annual turnover for violations of prohibited practices, up to €15 million or 3% for other violations."},
